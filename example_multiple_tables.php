...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <p class="lead">
                Run a select on multiple tables
            </p>
            <p>
                Select the `Name`, `Population` and `District` columns from the `city` table and the `Code`, `Region`, `Name` and `IndepYear` from the `country` table, using a left join on the `CountryCode` column in city and the `Code` column in country.<br>
                Give the `city` table an  alias of 'CIT' and from `city` give the `Name` column an alias of 'city_name' and the `Population` column an alias of 'pop'. Do not give the `country` table an alias but give the `Name` column an alias of 'country_name' and the `IndepYear` column an alias of 'year_of_ind'<br>
                Only return records where the `city` column `Population` is between '100000' and '500000', while the `country` column `IndepYear` is null, ordered by the city columns `District` ascending then `Population` descending, returning 10 records starting with the third one.
            </p>
